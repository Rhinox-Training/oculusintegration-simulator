...
//             {
//                 _headTransform.position = Vector3.Lerp(currentOvrFrame.HeadPosition, nextOvrFrame.HeadPosition,
//                     timer / _frameInterval);
//                 _headTransform.rotation = Quaternion.Lerp(currentOvrFrame.HeadRotation, nextOvrFrame.HeadRotation,
//                     timer / _frameInterval);
//                 _leftHandTransform.position = Vector3.Lerp(currentOvrFrame.LeftHandPosition, nextOvrFrame.LeftHandPosition,
//                     timer / _frameInterval);
//                 _leftHandTransform.rotation = Quaternion.Lerp(currentOvrFrame.LeftHandRotation, nextOvrFrame.LeftHandRotation,
//                     timer / _frameInterval);
//                 _rightHandTransform.position = Vector3.Lerp(currentOvrFrame.RightHandPosition, nextOvrFrame.RightHandPosition,
//                     timer / _frameInterval);
//                 _rightHandTransform.rotation = Quaternion.Lerp(currentOvrFrame.RightHandRotation, nextOvrFrame.RightHandRotation,
//                     timer / _frameInterval);
//                 
...
//         }
//         
//         private void ProcessFrameInput(OvrFrameInput input)
//         {
