...
namespace Rhinox.XR.UnityXR.Simulator
{
    public struct OvrFrameData
    {
        ...
        public List<OvrFrameInput> FrameInputs;
        ...
        /// <returns></returns>
        public bool ApproximatelyEqual(OvrFrameData other, float positionDeadZone, float rotationDeadZone)
        {
