...
public class BetterXRDeviceSimulator : MonoBehaviour
{
    ...
    private OVRInput.Controller _leftControllerState;

    private OculusHMD _hmdDevice;
    private OculusTouchController _leftControllerDevice;
    private OculusTouchController _rightControllerDevice;
    ...
    protected virtual void AddDevices()
    {
        ...
        _hmdDevice = InputSystem.AddDevice<OculusHMD>();
        if (_hmdDevice == null)
        {
            Debug.LogError($"Failed to create {nameof(OculusHMD)}.");
        }

        _leftControllerDevice = InputSystem.AddDevice<OculusTouchController>($"{nameof(OculusTouchController)} - {CommonUsages.LeftHand}");
        ...
        {
            Debug.LogError($"Failed to create {nameof(OculusTouchController)} for {CommonUsages.LeftHand}.", this);
        }

        _rightControllerDevice = InputSystem.AddDevice<OculusTouchController>($"{nameof(OculusTouchController)} - {CommonUsages.RightHand}");
        ...
        {
            Debug.LogError($"Failed to create {nameof(OculusTouchController)} for {CommonUsages.RightHand}.", this);
        }
